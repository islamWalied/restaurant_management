                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="guest_number" name="guest_number" value="{{$table->guest_number}}"
                                       class="block w-full dark:bg-gray-700 text-white appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('guest') border-red-400 @enderror" required/>
                            </div>
                            @error('guest')
